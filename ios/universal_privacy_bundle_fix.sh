...
# Universal Privacy Bundle Fix Script
# This script creates a comprehensive solution for missing privacy bundle files
# It handles all Flutter plugins that require privacy manifests

set -e
set -u
set -o pipefail

echo "=== Universal Privacy Bundle Fix Script ==="
...
create_privacy_bundle_universal() {
    local plugin_name="$1"
...
PRIVACY_XML_EOF
    ...
    # Add common Flutter build paths (based on the error message pattern)
...
for plugin in "${PRIVACY_PLUGINS[@]}"; do
    create_privacy_bundle_universal "$plugin"
done
...
echo "=== Universal Privacy Bundle Fix Complete ==="