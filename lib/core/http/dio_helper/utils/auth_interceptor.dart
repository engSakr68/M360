...
import 'package:member360/core/http/dio_helper/actions/post.dart';
import 'package:member360/core/http/generic_http/api_names.dart';
import 'package:member360/core/http/models/request_body_model.dart';
...
class AuthInterceptor extends Interceptor {
    ...
    if (err.response?.statusCode == 403 || err.response?.statusCode == 401) {
      ...
      if (result) {
        ...
        if (result) {
          ...
          if (err.requestOptions.headers["requiresToken"] == true &&
              isInvalidSession) {
  ...
  Future<bool> _retry(
    ...
    try {
      ...
      dioException.requestOptions.headers["Authorization"] =
