...
import 'package:member360/core/constants/input_field_style/custom_input_decoration.dart';
import 'package:member360/core/constants/input_field_style/profile_input_decoration.dart';
  ...
  Widget buildFormFiled(BuildContext context) {
    return TextFormField(
      ...
      style: AppTextStyle.s14_w400(
          ...
          .copyWith(fontFamily: fontFamily, fontSize: fontSize),
      decoration: profileStyle? ProfileInputDecoration(
        labelTxt: label,
        hint: hint,
        prefIcon: prefixIcon,
        sufIcon: suffixIcon,
