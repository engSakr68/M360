import 'package:member360/core/models/localized_name_model/localized_name_model.dart';
...
class FlutterEnvironmentConfigReader implements IEnvironmentConfigReader {
  ...
  @override
  String getBaseUrl() =>
      _orgBaseUrl ?? "https://${const String.fromEnvironment('APP_BASE_URL')}";
  ...
  @override
  String getLogoUrl() =>
      getBaseUrl() + const String.fromEnvironment('APP_LOGO_URL');
  ...
  String getAnonymousClientId() =>
      const String.fromEnvironment('APP_ANONYMOUS_CLIENT_ID');

  @override
  String getAnonymousClientSECRET() =>
      const String.fromEnvironment('APP_ANONYMOUS_CLIENT_SECRET');

  @override
  String getAnonymousGrantType() =>
      const String.fromEnvironment('APP_GRANT_TYPE');
  ...
  @override
  String getAppId() => const String.fromEnvironment('APP_ID');
