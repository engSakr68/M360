...
class BuildChooseDescription extends StatelessWidget {
  final DeactivateController controller;
  const BuildChooseDescription({super.key, required this.controller});
          ...
          return Container(
              ...
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) => InkWell(
                        onTap: () => controller.setDescription(
                          context,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Visibility(
                                visible:
                                    state.data == controller.descriptions[index],
                                replacement: Icon(
